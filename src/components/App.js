                    ...
                    <Switch key={location.pathname} location={location}>
                      ...
                      <Route
                        ...
                        component={(path) => {
                          ...
                          const reviews = this.props.payload.reduce((array, business) => array.concat(business.reviews), []);
                      ...
                      />
                      <Route path="/businesses" component={() => <Businesses items={this.props.payload} />} />
